...
@section('content')
        ...
        <!-- subheader -->
        <section id="subheader" data-bgimage="url('{{asset('themes/images/background/subheader-8.jpg')}}')" data-stellar-background-ratio=".9">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="blog-read">
                                <div class="post-content">
                                    <div class="post-image">
                                        <img src="{{asset('themes/images/blog/pic-blog-1.jpg')}}" alt="" />
                                    </div>
								...
								<div class="post-meta">
                                    <span><i class="fa fa-user id-color"></i>By: <a href="#">Admin</a></span>
                    ...
                    <div id="sidebar" class="col-md-4">
                        <div class="widget widget-post">
                            ...
                            <ul class="de-bloglist-type-1">
                                <li>
                                    <div class="d-image">
                                        <img src="{{asset('themes/images/news-thumbnail/pic-blog-1.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{asset('themes/images/news-thumbnail/pic-blog-2.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{asset('themes/images/news-thumbnail/pic-blog-3.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{asset('themes/images/news-thumbnail/pic-blog-4.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{asset('themes/images/news-thumbnail/pic-blog-5.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
