                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="widget widget-address">
                            <address>
                                <span>MayFox House, Riverside Gardens Rd, Off Riverside Drive Westlands Riverside - Nairobi - Kenya</span>
                                {{-- <span><strong>Phone:</strong>+254 701 211 206</span> --}}
                                <span><strong>Oile:</strong>  +254 737 211 206</span>
                                <span><strong>Mobile:</strong>+254 701 211 206</span>
                                <span><strong>Mobile:</strong>+254 733 211 206</span>
                                <span><strong>Email:</strong><a href="mailto:info@meglinkventures.co.ke">info@meglinkventures.co.ke</a></span>
